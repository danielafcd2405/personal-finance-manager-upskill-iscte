...
public class Views {
    ...
    public static void monthlySummaryView(Map<Long, Account> accounts, List<Category> categories, Account account) {
        // Header
        System.out.println(separator1);
        ...
        System.out.println(lineBreaks);
        PersonalFinanceManagerUserInterface.monthlySummaryChooseAccountMenu(accounts, categories);
    }
